...
print("*" * 86)
print(
    """1. Used to validate the string is ending with the given substring or tuple of strings
...
b3 = st.endswith("ic")
b4 = st.endswith(("on", "an"))  # Tuple of strings. True, if any one item satisfice
